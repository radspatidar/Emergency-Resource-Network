...
export default function Login() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-[#0b1120] text-white p-4 font-sans selection:bg-brand-500 selection:text-white relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-[#131b2e] rounded-2xl border border-slate-800/80 shadow-2xl relative z-10 overflow-hidden">
        ...
        <div className="p-8 sm:p-10 flex flex-col items-center">
          ...
          <h1 className="text-2xl font-bold text-white mb-1">HealthResQ</h1>
          <p className="text-xs text-slate-400 mb-4">Emergency Resource Coordination System</p>
          ...
          <div className="w-full space-y-1.5 mb-6">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="py-1.5 px-2 bg-slate-800 hover:bg-slate-700 text-slate-200 text-[10px] font-bold rounded-lg border border-slate-700 transition-colors truncate"
              >
                System Admin
              </button>
              <button
              ...
              <button
                ...
                className="py-1.5 px-2 bg-blue-900/60 hover:bg-blue-800/80 text-blue-300 text-[10px] font-bold rounded-lg border border-blue-700/60 transition-colors truncate"
              >
                EMS Coord
              </button>
              <button
          ...
          <form className="w-full space-y-4" onSubmit={handleLogin}>
            <div className="space-y-1.5 text-left">
              ...
              <input 
                ...
                className="w-full px-4 py-2.5 bg-[#0b1120] border border-slate-700/80 rounded-xl text-sm text-white placeholder-slate-600 focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 transition-all"
              />
            </div>
            ...
            <div className="space-y-1.5 text-left relative">
              ...
              <div className="relative">
                <input 
                  ...
                  className="w-full pl-4 pr-12 py-2.5 bg-[#0b1120] border border-slate-700/80 rounded-xl text-sm text-white placeholder-slate-600 focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 transition-all"
                />
                <button 
                  type="button"
            ...
            {error && (
              <div className="px-4 py-2.5 bg-red-500/10 border border-red-500/30 rounded-xl text-xs text-red-400 text-center">
                {error}
              </div>
            )}
            ...
            <button 
              type="submit"
              disabled={isLoading}
              className="w-full py-3 px-4 bg-brand-600 hover:bg-brand-500 active:bg-brand-700 text-white text-sm font-bold rounded-xl transition-all shadow-lg shadow-brand-600/20 mt-2 disabled:opacity-70 disabled:cursor-not-allowed flex justify-center items-center"
            >
              {isLoading ? (
      ...
      {/* Footer text */}
      <p className="mt-6 text-[11px] text-slate-600 font-medium z-10">
